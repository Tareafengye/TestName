...
public class TinyWindowPlayActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        String videoUrl = Environment.getExternalStorageDirectory().getPath().concat("http://tanzi27niu.cdsb.mobi/wps/wp-content/uploads/2017/04/2017-04-21_16-41-07.mp4");
        mNiceVideoPlayer.setUp("http://tanzi27niu.cdsb.mobi/wps/wp-content/uploads/2017/04/2017-04-21_16-41-07.mp4", null);
